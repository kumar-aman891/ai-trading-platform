...
`SqlAlchemyCashLedgerRepository`, `SqlAlchemyInstrumentRepository`, and
`SqlAlchemyRiskConfigRepository` are read/write additions with no matching
domain Protocol - see each module's own docstring for why.
"""
